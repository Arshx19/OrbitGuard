...
import { useSettings, formatDistanceKm, formatDistanceM } from '../context/SettingsContext'
    ...
    <div className="panel p-5">
      ...
      {candidate && (
        <div className="mt-4 grid grid-cols-2 gap-y-2 border-t border-line pt-3 text-xs">
          ...
          <span className="text-right font-mono text-ink">{formatDistanceM(conjunction.minDistanceM, units)}</span>
          <span className="text-ink-faint">Predicted separation</span>
          <span className="text-right font-mono text-risk-green">{formatDistanceKm(candidate.newSeparationKm, units)}</span>
